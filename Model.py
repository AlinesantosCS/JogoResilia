...
def cenarioConseguencias():
    ...
    if alternativa == '1':
        ...
        print('Poderá ir mais longe, mesmo não realizando todas as atividades do curso aprendeu basntante conteúdos,\n por este motivo passou no processo seletivo para a resilia educação, está pronto para se tornar uma analista de dados?')
        print('Aqui está seu desafio de caminhada, organizar vida pessoal, casa e mais dois cursos, o que fará  com tudo isso ?')
